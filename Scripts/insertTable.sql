BEGIN TRY
	BEGIN TRANSACTION
		...
		('04','seniores','cenas','01')
		
		INSERT INTO ACTIVIDADE_EQUIPA VALUES
		('01','01','15:00:00.0000','16:00:00.0000'),
		...
		('01','João Oliveira','2014-02-03','+351915673467','11','33145713 ZZ4','112346789','11','1'),
		('02','Pedro Pereira','2005-07-11','+351912756452','9','53465132 ZZ7','676348234','12','1'),
		('03','Pedro Custódio','2010-10-25','+351936748243','4','63456345 ZZ1','142142489','13','1'),
		('04','António Rodrigues','2004-02-21','+351931256323','4','45673409 ZZ8','243523534','13','1'),
		('05','Guilherme Duarte','2004-01-23','+351936858658','11','43567534 ZZ4','523452345','10','3'),
		('06','Rui Sinel','2013-03-01','+351938976785','9','23453545 ZZ1','235345334','14','2'),
		('07','Bruno Nogueira','2013-02-05','+351917698455','4','54357543 ZZ1','253434532','14','1'),
		('08','João Quadros','2004-01-11','+351931233245','4','13445323 ZZ8','123412389','15','1')
